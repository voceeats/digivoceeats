    ...
    <div style={{ minHeight: "100vh", background: "#ffffff", color: "#111111" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 24px", fontFamily: "Georgia, serif" }}>
        ...
        {[
          ...
          { title: "7. Restaurant Partners", content: "DigiVoceEats partners with restaurants to provide ordering services. We are not responsible for food quality, preparation, or delivery — those remain the responsibility of the restaurant." },
          { title: "8. Limitation of Liability", content: "DigiVoceEats and Diginetplore LLC shall not be liable for any indirect or consequential damages arising from use of our service." },
