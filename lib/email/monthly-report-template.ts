import { monthLabel, type MonthlyReportMetrics } from "@/lib/email/report-data";
...
export function monthlyReportSubject(year: number, month: number) {
  return `Your DigiVoceEats Report — ${monthLabel(year, month)}`;
}
    ...
    metrics.top_5_items.length === 0
      ...
      : metrics.top_5_items
          ...
          <tr>
            ...
            <td style="padding:10px 0;border-bottom:1px solid #F3F4F6;text-align:right;color:#6B7280;font-weight:600;">${item.count}×</td>
          </tr>`,
          )
          .join("");
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#ffffff;padding:36px 32px;">
            <p style="color:#374151;font-size:16px;margin:0 0 6px;">Hi ${ownerName},</p>
            <h1 style="color:#111827;font-size:24px;font-weight:900;margin:0 0 8px;line-height:1.2;">${period}</h1>
            <p style="color:#6B7280;font-size:14px;margin:0 0 28px;line-height:1.6;">
              Here's how <strong style="color:#111827;">${restaurantName}</strong> performed on DigiVoceEats voice ordering.
            </p>
              ...
              <tr>
                <td width="50%" style="padding:4px;">
                  <div style="background:#F9FAFB;border:1px solid #E5E7EB;border-radius:12px;padding:20px;">
                    ...
                    <div style="color:#111827;font-size:32px;font-weight:900;margin-top:4px;">${metrics.total_orders}</div>
                  </div>
                </td>
                <td width="50%" style="padding:4px;">
                  <div style="background:#F9FAFB;border:1px solid #E5E7EB;border-radius:12px;padding:20px;">
                    <div style="color:#6B7280;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.8px;">Total Revenue</div>
                    <div style="color:#111827;font-size:32px;font-weight:900;margin-top:4px;">${money(metrics.total_revenue)}</div>
                  </div>
                </td>
              </tr>
              <tr>
                <td width="50%" style="padding:4px;">
                  <div style="background:#ECFDF5;border:1px solid #A7F3D0;border-radius:12px;padding:20px;">
                    ...
                    <div style="color:#047857;font-size:28px;font-weight:900;margin-top:4px;">${money(metrics.restaurant_payout)}</div>
                  </div>
                </td>
                <td width="50%" style="padding:4px;">
                  <div style="background:#FFF7F3;border:1px solid #FFD4C2;border-radius:12px;padding:20px;">
                    ...
                    <div style="color:#FF6B35;font-size:28px;font-weight:900;margin-top:4px;">${money(metrics.platform_fee)}</div>
                  </div>
                </td>
              </tr>
            </table>
              ...
              <tr>
                <td width="50%" style="padding-right:6px;">
                  <div style="background:#EEF2FF;border:1px solid #C7D2FE;border-radius:12px;padding:18px;">
                    ...
                    <div style="color:#111827;font-size:20px;font-weight:900;margin-top:6px;">${metrics.busiest_day.label}</div>
                    <div style="color:#6B7280;font-size:13px;margin-top:2px;">${metrics.busiest_day.count} orders</div>
                  </div>
                </td>
                <td width="50%" style="padding-left:6px;">
                  <div style="background:#EEF2FF;border:1px solid #C7D2FE;border-radius:12px;padding:18px;">
                    ...
                    <div style="color:#111827;font-size:20px;font-weight:900;margin-top:6px;">${metrics.busiest_hour.label}</div>
                    <div style="color:#6B7280;font-size:13px;margin-top:2px;">${metrics.busiest_hour.count} orders</div>
                  </div>
                </td>
              </tr>
            </table>
